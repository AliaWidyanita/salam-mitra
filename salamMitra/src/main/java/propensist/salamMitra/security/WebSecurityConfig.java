        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
            http
                    ...
                    .authorizeHttpRequests(requests -> requests
                            ...
                            .requestMatchers(new AntPathRequestMatcher("/pengajuan")).hasAnyAuthority("mitra", "manajemen", "admin_PROGRAM")
                            .requestMatchers(new AntPathRequestMatcher("/detail-pengajuan-**")).hasAnyAuthority("mitra", "manajemen", "admin_PROGRAM")
